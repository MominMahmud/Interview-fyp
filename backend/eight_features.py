...
def audio_text_anlysis(address):
    ...
    return (speaker_text,silence,speech_to_silence_ratio,avg_silence_duration,Avg_silence_dur_per_minute,num_unique_words,unique_words_to_total_no_of_words_ratio,rate_of_words_per_minute,sentiment)
